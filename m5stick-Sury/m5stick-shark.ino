// sury Firmware for the M5 Stack Stick C Plus
// github.com/AH2005NA
...
// -=-=- sury Language for Menu and Portal -=- Thanks, @marivaaldo and @Mmatuda! -=-=-
...
//  #define BITMAP DISP.pushImage(0, 0, 240, 135, (uint16_t *)suryMatrix);// NOT TESTED YET
...
#define PortBpinIN 33
#define PortBpinOUT 32
#define BITMAP DISP.pushImage(0, 0, 240, 135, (uint16_t *)suryMatrix);
...
#define BITMAP DISP.pushImage(0, 0, 240, 240, (uint16_t *)suryMatrix);
#define VBAT_PIN 15
...
#include "ble.h"
#include "IR_AH.h"
#include "applejuice.h" // Nuevo archivo incluido
#include "deauth.h" // Nuevo archivo incluido
#include "Display.h" // Nuevo archivo incluido
...
QRCODE qrcodes[] = {
  { TXT_BACK, "" },
  { "GITHUB", "https://github.com/AH2005NA/m5stick-sury" },
...
//Serial.printf("Brightness: %d\n", bright);
  ...
  DISP.setCursor(0, 39);
      ...
      void IR_AH_Receive_setup(void) {
        ...
        irrecv.enableIRIn();
        //DISP.qrcode("https://github.com/AH2005NA/m5stick-sury/blob/main/IR_AH_Remotes/README.md", 105, 0, 135, 5);
      }
...
#ifdef DIAL
        DISP.qrcode("https://github.com/AH2005NA/m5stick-sury", 145, 65, 100, 5);
#else
  DISP.qrcode("https://github.com/AH2005NA/m5stick-sury", 145, 22, 100, 5);
#endif
        DISP.setTextColor(BLACK, WHITE);
        DISP.setTextSize(MEDIUM_TEXT);
#ifdef DIAL
        DISP.setCursor((240 - DISP.textWidth(" M5-sury")) / 2, 40);
#else
  DISP.setCursor(0, 10);
#endif
        DISP.print(" M5-sury\n");
...
//Random Startupsound 0...6
        ...
        DISP.setTextSize(BIG_TEXT);
#if defined(DIAL)
        DISP.setCursor((240 - DISP.textWidth("M5-sury")) / 2, 55);
#else
  DISP.setCursor(40, 0);
#endif
        DISP.println("M5-sury");
        DISP.setTextSize(SMALL_TEXT);
#if defined(DIAL)
        DISP.setCursor((240 - DISP.textWidth(String(sury_VERSION + platformName) + "-")) / 2, 90);
#else
  DISP.setCursor(10, 30);
#endif
        DISP.printf("%s-%s", sury_VERSION, platformName);
        screenBrightness(brightness);
#if defined(CARDPUTER)
